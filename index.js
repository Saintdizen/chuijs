...
//ПОЛЯ ВВОДА
const { TextInput } = require('./framework/components/inputs/chui_text');
const { DateInput } = require('./framework/components/inputs/chui_date');
const { NumberInput } = require('./framework/components/inputs/chui_number');
const { EmailInput } = require('./framework/components/inputs/chui_email');
const { PasswordInput } = require('./framework/components/inputs/chui_password');
const { Select } = require('./framework/components/inputs/chui_select_box');
const { ComboBox } = require('./framework/components/inputs/chui_combo_box');
const { TextArea } = require('./framework/components/inputs/chui_text_area');
const { RadioButton } = require('./framework/components/inputs/chui_radio_button');
const { CheckBox } = require('./framework/components/inputs/chui_check_box');
const { RadioGroup } = require('./framework/components/chui_radio_group');
//==========
const { MenuItem } = require('./framework/tray_bar/chui_menu_items');
const { ContextMenu } = require('./framework/components/context/chui_contextMenu');
const { CtxMenuItem } = require('./framework/components/context/chui_ctx_menuItem');
...
const { TextEditor } = require('./framework/components/chui_text_editor');
