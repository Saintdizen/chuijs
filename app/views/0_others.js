...
class OthersComponentsPage extends Page {
    constructor() {
        ...
        let button_4 = new Button({
            ...
            clickEvent: async () => {
                let prompt_res = await popup.prompt({
                    ...
                    message:
                        'Если подтвердите удаление файла "Что-то там.deb" начнется полная катастрофа! Земля остановится!',
                    okText: "Войти",
                    cancelText: "Отмена",
                    inputs: {
                        /*text: {
            ...
            components: [
                ...
                TreeView.ExpandButton({
                    ...
                    subButtons: [
                        TreeView.ExpandButton({
                            title: "Выпадашка 1",
                            components: [new Button({ title: "Кнопочка!" })],
                        }),
                        TreeView.ExpandButton({
                            title: "Выпадашка 2",
                            components: [new Button({ title: "Кнопочка!" })],
        ...
        let h1_context = new H(1, "Контекстное меню");
        let context_button = new Button({ title: "Нажмите ПКМ по кнопке" });
        ...
        context_menu.attach(context_button.set());
        this.add(h1_context, context_button);
