...
class NumberInput {
    ...
    constructor(options = { name: String(), title: String(), required: Boolean(), width: String() }) {
        ...
        this.#number_button_plus.innerHTML = new Icon(
            Icons.CONTENT.ADD,
            undefined,
        ...
        this.#number_button_minus.innerHTML = new Icon(
        ...
        this.#number_button_plus_disabled.innerHTML = new Icon(
            Icons.CONTENT.ADD,
            undefined,
        ...
        this.#number_button_minus_disabled.innerHTML = new Icon(
            Icons.CONTENT.REMOVE,
            undefined,
            "var(--text_color_disabled)"
        ).getHTML();
