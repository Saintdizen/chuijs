class FieldSet {
    ...
    constructor(
        ...
        if (options.components.length !== 0)
            for (let component of options.components) this.#fieldset.appendChild(component.set());
    }
    getId() {
    ...
    setLegend(text = String()) {
        return (this.#legend.innerText = text);
    }
    add(...components) {
        for (let component of components) this.#fieldset.appendChild(component.set());
    }
    set() {
        return this.#chui_fieldset;
    }
}
