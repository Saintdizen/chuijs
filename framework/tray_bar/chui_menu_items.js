class MenuItem {
    button(title = String(), action = () => {}) {
        return { label: title, click: action };
    }
    separator() {
        return { type: "separator" };
    }
    submenu(title = String(), submenu_list = Array()) {
        return { label: title, submenu: submenu_list };
    }
    radio(title = String(), checked = Boolean(), action = () => {}) {
        return { label: title, type: "radio", checked: checked, click: action };
    }
    checkbox(title = String(), checked = Boolean(), action = () => {}) {
