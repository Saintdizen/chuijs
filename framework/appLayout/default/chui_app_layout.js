...
class AppLayout extends Route {
    ...
    constructor() {
        ...
        // Глобальные стили
        chui_functions.style_parse(require("./styles.json").global, 'chUiJS_Global');
        chui_functions.parseRootStyles("light", require("./styles.json").light, "chUiJS_Light")
        chui_functions.parseRootStyles("dark", require("./styles.json").dark, "chUiJS_Dark")
        // ===
